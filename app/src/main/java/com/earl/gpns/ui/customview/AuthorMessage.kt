package com.earl.gpns.ui.customview
...
class AuthorMessage(context: Context) : View(context) {

    private val paint: Paint = Paint()
    private val rect: Rect = Rect()
    val res: Resources = this.resources
    private var bitmap: Bitmap = BitmapFactory.decodeResource(res, R.drawable.search)
